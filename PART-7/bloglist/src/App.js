...
import { initialize_Blogs, like, comment } from './reducers/blogReducer'
import { initialize_Users } from './reducers/userReducer'
...
const App = () => {
  ...
  useEffect(() => {
    ...
    dispatch(initialize_Blogs())
    dispatch(initialize_Users())
  }, [dispatch])
